...
def test_qvhighlights_available_sweep_script_contains_expected_commands() -> None:
    script_path = Path("scripts/run_qvhighlights_available_sweep.sh")
    ...
    assert "data/qvhighlights/qvhighlights_val_diverse_subset_manifest.json" in script_text
    assert "results/qvhighlights_available_sweep" in script_text
