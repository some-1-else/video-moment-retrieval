...
def test_qvhighlights_readable_sweep_cached_script_contains_expected_commands() -> None:
    script_path = Path("scripts/run_qvhighlights_readable_sweep_cached.sh")
    ...
    assert "--use-cache" in script_text
    assert "--embeddings-cache-dir" in script_text
    assert "results/embeddings/qvhighlights_readable" in script_text
    assert "results/qvhighlights_readable_sweep_cached" in script_text
